  ...
  return (
    <>
      <header>
        <div
          style={{ gap: "2rem" }}
          className="header-section-a flex align-center"
        >
          <div onClick={temp} className="logo">
            ...
            >
              <img src="Forex-logos_black.png" className="logo-img" />
            </Link>
          </div>
          <div ref={myRef} className="search-bar-area">
            <div
              style={{ gap: "50px" }}
              className="search-bar flex justify-between align-center"
            >
              <div
                style={{ gap: "10px" }}
        ...
        <nav className="header-nav">
          <ul
            style={{ gap: "1rem" }}
            className="header-section-b header-list-container flex justify-center"
          >
            <Link
              className="cursor-pointer"
              to="/"
